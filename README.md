...
### Further Information
* In general, your product should handle the audio-related part of the dealership experience. This can achieved by generating sounds, playing music obtained from a 3rd party service or from predefined playlists, or in other ways. The only thing important is that there is no silence. 
...
* You can implement functionality that is aimed at the showroom visitors (i.e. via buttons on a tablet). Also, there is the possibility to train sales staff to adjust settings according to specific situations. 
